package com.limyel.haoyuan.mall.common.auth.entity;

import com.limyel.haoyuan.mall.common.auth.constant.UserStatusConstant;
...
public class SysUserDetails implements MallUserDetails {
    ...
    public boolean isEnabled() {
        return UserStatusConstant.ENABLE.equals(sysUser.getStatus());
    }
}
