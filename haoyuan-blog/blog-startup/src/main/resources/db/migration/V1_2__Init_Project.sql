...
INSERT INTO `project_project` (id, name, summary, url, status) VALUES
    ...
    (3, 'clear-sql', '一个清晰的、容易理解的关系型数据库，基于 Java 实现。', 'https://github.com/limyel/clear-sql', 1),
    (4, 'simple-kv', '一个简单的键值对数据库，基于 Go 实现。', 'https://github.com/limyel/simple-kv', 1),
    (5, 'light-mq', '一个轻量的、清晰的简易消息队列，基于 Java 实现。', 'https://github.com/limyel/light-mq', 1);