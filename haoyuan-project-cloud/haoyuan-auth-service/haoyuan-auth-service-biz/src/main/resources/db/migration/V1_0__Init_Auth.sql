...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('haoyuan-admin', '', '{noop}123456', 'all', 'password,captcha,sms_code,refresh_token', NULL, '', 3600, 7200, NULL, 'true');
INSERT INTO `oauth_client_details` VALUES ('haoyuan-app', '', '{noop}123456', 'all', 'app_password,sms_code,refresh_token', NULL, NULL, 3600, 7200, NULL, 'true');
